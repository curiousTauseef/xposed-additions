    ...
    private void setup() {
    	if (mSetup != (mSetup = true)) {
    		...
    		if ("add_condition".equals(mAction)) {
				...
				preferenceScreen.addPreference(getSelectPreference(getResources().getString(R.string.condition_type__on), null, "on", null, null));
				preferenceScreen.addPreference(getSelectPreference(getResources().getString(R.string.condition_type__off), null, "off", null, null));
				preferenceScreen.addPreference(getSelectPreference(getResources().getString(R.string.condition_type__guard), null, "guard", null, null));
